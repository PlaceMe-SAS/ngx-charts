...
exports.PositionHelper = undefined;
...
var PositionHelper = /** @class */function () {
    ...
    PositionHelper.positionCaret = function (placement, elmDim, hostDim, caretDimensions, alignment) {
        var top = 0;
        var left = 0;
        if (placement === _placement.PlacementTypes.right) {
            left = -7;
            top = PositionHelper.calculateVerticalCaret(hostDim, elmDim, caretDimensions, alignment);
        } else if (placement === _placement.PlacementTypes.left) {
            left = elmDim.width;
            top = PositionHelper.calculateVerticalCaret(hostDim, elmDim, caretDimensions, alignment);
        } else if (placement === _placement.PlacementTypes.top) {
            top = elmDim.height;
            left = PositionHelper.calculateHorizontalCaret(hostDim, elmDim, caretDimensions, alignment);
        } else if (placement === _placement.PlacementTypes.bottom) {
            top = -7;
            left = PositionHelper.calculateHorizontalCaret(hostDim, elmDim, caretDimensions, alignment);
        }
    ...
    PositionHelper.determinePlacement = function (placement, elmDim, hostDim, spacing, alignment) {
        ...
        if (shouldFlip) {
            if (placement === _placement.PlacementTypes.right) {
                return _placement.PlacementTypes.left;
            } else if (placement === _placement.PlacementTypes.left) {
                return _placement.PlacementTypes.right;
            } else if (placement === _placement.PlacementTypes.top) {
                return _placement.PlacementTypes.bottom;
            } else if (placement === _placement.PlacementTypes.bottom) {
                return _placement.PlacementTypes.top;
            }
        }
        return placement;
    };
