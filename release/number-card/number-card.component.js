...
exports.NumberCardComponent = undefined;
...
var NumberCardComponent = /** @class */function (_super) {
    ...
    NumberCardComponent.prototype.update = function () {
        ...
        var size = (0, _gridLayout.gridSize)(this.dims, this.results.length, 150);
        var N = size[0] * size[1];
        var data = this.results.slice();
        while (data.length < N) {
            data.push({ value: null });
        }
        this.data = (0, _gridLayout.gridLayout)(this.dims, data, 150, this.designatedTotal);
    };
    ...
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NumberCardComponent.prototype, "cardColor", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NumberCardComponent.prototype, "bandColor", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NumberCardComponent.prototype, "emptyColor", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NumberCardComponent.prototype, "innerPadding", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", String)], NumberCardComponent.prototype, "textColor", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NumberCardComponent.prototype, "valueFormatting", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Object)], NumberCardComponent.prototype, "labelFormatting", void 0);
    __decorate([(0, _core.Input)(), __metadata("design:type", Number)], NumberCardComponent.prototype, "designatedTotal", void 0);
    NumberCardComponent = __decorate([(0, _core.Component)({
